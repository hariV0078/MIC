...
def validate_theme(submission: EventSubmission, ollama_client: OllamaClient) -> List[ValidationResult]:
    """Run all theme validations."""
    results = []
    
    results.append(validate_theme_alignment(submission, ollama_client))
