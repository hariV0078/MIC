...
class OllamaClient:
    ...
    def check_iic_alignment(self, title: str, objectives: str = "", learning_outcomes: str = "", theme: str = "") -> tuple[bool, str]:
        """
        Sandwich Logic: Python Hard Rules -> LLM Semantic Check
        """
        ...
        RULES:
        1. ACCEPT: Workshops on "Design Thinking", "Critical Thinking", "Problem Solving" applied to technical fields (e.g. "Design Thinking in Civil Engineering").
